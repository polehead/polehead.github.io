  ...
  <style>
    ...
    *::after {
    ...
    @media (max-width: 480px) {
      ...
      /* Tighten the main wrapper */
      .wrap {
        padding: 0 8px 48px;
      }

      /* Hero card inner spacing */
      .hero-inner {
        padding: 16px 10px 14px;
        gap: 10px;
      }

      /* Team badges smaller on mobile */
      .badge-ring {
        width: 56px;
        height: 56px;
      }
      ...
      /* Motivation row: stack elements to prevent overflow */
      .mot-row {
        flex-wrap: wrap;
        justify-content: center;
        gap: 6px;
      ...
      /* Odds row: keep 3-col but reduce padding */
      .odds-row {
        gap: 4px;
      }
      ...
      /* Prediction table: allow text wrapping on mobile */
      .pred-table {
        min-width: unset;
        width: 100%;
      }
      ...
      /* Score boxes: single column on tiny screens */
      .s-boxes {
        grid-template-columns: 1fr;
      }
      ...
      /* Analysis grid: force single column */
      .analysis-grid {
        gap: 12px;
      }
    ...
    /* Mid-range mobile (up to 600px) — catch tablets in portrait */
    ...
    /* Table wrapper ensures scroll only when truly necessary */
    .table-wrap {
      width: 100%;
      overflow-x: auto;
      -webkit-overflow-scrolling: touch;
...
<body>
    ...
    <div class="grid">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <ul
            style="font-size: clamp(11px, 3vw, 12px); color: var(--label); padding-left: 15px; line-height: 1.6; margin-bottom: 15px;">
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div style="font-size: 9px; color: var(--muted); text-align: right; margin-top: 8px;">*Data mapped via <a
    ...
    <div class="hero-card bur-mci-bg" style="margin-top: 40px;">
      <div class="hero-inner">
        ...
        <div class="odds-row">
          ...
          <div class="odds-box ob-val"
            style="border-color: rgba(108, 171, 221, 0.4) !important; background: linear-gradient(135deg, rgba(108, 171, 221, .07), var(--bg3)) !important;">
  ...
  <footer
    style="text-align:center;padding:24px 16px;font-size:10px;color:var(--muted);border-top:1px solid var(--border);position:relative;z-index:1">
    ...
    <p style="margin-top: 6px;">
      ...
      <strong style="color: var(--red); text-decoration: underline; display: inline-block; margin-top: 4px;">ALWAYS
        GAMBLE RESPONSIBLY, THIS IS NOT FINANCIAL ADVICE</strong>
    </p>
  </footer>
